  ...
  const posts = [
    {
      ...
      category: 'CASE STUDY',
      title: 'Korba',
      content: '사용자 맞춤형 웹 경험을 설계하고 구현한 프로젝트입니다. 반응형 UI와 직관적인 흐름에 집중했습니다.',
      tags: ['태그1', '태그2'],
    ...
    },
    {
      ...
      category: 'CASE STUDY',
      title: 'Picnote',
      content: '이미지와 메모를 함께 관리할 수 있는 서비스 예시입니다. 태그 분류와 목록 구성을 중심으로 제작했습니다.',
      tags: ['태그2'],
    ...
    },
    {
      ...
      category: 'CASE STUDY',
      title: 'Memo Archive',
      content: '저장된 메모를 한곳에서 모아보고 관리할 수 있는 아카이브 페이지입니다. 검색과 필터 확장을 고려했습니다.',
      tags: ['태그3'],
